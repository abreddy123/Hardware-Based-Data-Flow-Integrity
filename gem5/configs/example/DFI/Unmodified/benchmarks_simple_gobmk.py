...
gobmk = Process()
gobmk.executable =  spec_dir + 'gobmk'
print("Starting input.source")
gobmk.cmd = [gobmk.executable] + ['--quiet','--mode', 'gtp']
gobmk.input = data_dir + '445.gobmk/data/ref/input/13x13.tst'
#gobmk.cmd = [gobmk.executable] + ['-d', input_program0]
print("All Done")
system.cpu.workload = gobmk
...
print("Begin simulation with gobmk workload, X86")
